...
namespace BobbyPinApp.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public UserInfoesController(CloudApplicationContext context)
        {
            _context = context;
        }
        ...
        {
            var cloudApplicationContext = _context.UserInfo.Include(u => u.Login).Include(u => u.Rating);
        ...
        {
            ViewData["LoginId"] = new SelectList(_context.LoginInfo, "UserId", "Username");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,City,UsaState,Zip,PhoneNumber,Email,Age,DateJoin,RatingId,LoginId")] UserInfo userInfo)
        {
